#!/usr/bin/env python3
"""
Recupero codici sconto Euronics da shopilo.it
Sursa: https://shopilo.it/negozi/euronics.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/euronics.it"
STORE_NAME = "Euronics"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Euronics da shopilo.it"""
    headers = {
